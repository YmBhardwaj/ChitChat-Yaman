...
function Sidebar() {
    ...
    useEffect(() => {
        ...
        user.then((doc) => {
            if (
                doc.data().profileUrl !==
                "https://firebasestorage.googleapis.com/v0/b/yaman-auth-dev.appspot.com/o/users%2Fu0BdamkPricQpXLgFJnB7cZSsUh1%2FProfileImage?alt=media&token=50fda9c4-2f87-4c5c-95bd-19e682d5c367"
            )
    ...
    return (
        <div className="ChatSidebar">
            <div className="ChatSidebar-Header">
                ...
                <div className="ChatLogo">yaman Chats</div>
                <button
