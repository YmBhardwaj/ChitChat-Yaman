          ...
          <div className="FooterLinksWrapper">
            ...
            <div className="FooterLinkItems">
              ...
              <a
                ...
                href="https://www.instagram.com/yamanbhardwaj.me/"
                target="_blank"
                rel="noreferrer"
              ...
              <a
                className="FooterLink"
                href="https://www.linkedin.com/in/yaman-bhardwaj-018b6318b/"
                target="_blank"
                rel="noreferrer"
                aria-label="Linkedin"
              >
              ...
              <a
                className="FooterLink"
                href="https://github.com/yamanbhardwaj"
                target="_blank"
                rel="noreferrer"
                aria-label="Github"
              >
          ...
          <div className="SocialMediaWrap">
            ...
            <small className="WebsiteRights">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                aria-label="yaman bhardwaj"
              >
                Made with ❤️ by yaman bhardwaj
              </a>
            </small>
